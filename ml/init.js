...
const Song = require('../models/Song.js'); // Adjust the path to your Song model if necessary

// These variables will hold our ML data in memory for the entire server's lifetime
let songDataForML = null;
let songEmbeddings = null;
let isModelReady = false;

/**
 * Initializes the recommendation model. Fetches songs, runs the Python script
 * to create embeddings, and stores them in memory.
 * This is the slow part and should only be run ONCE at server start.
 */
